            ...
            blocks=[
                ...
                SectionBlock(
                    text={
                        ...
                        "- *추가 글 제출*: 동일 회차에 글을 추가로 제출할 때마다 *추가 포인트* 획득\n"
                        "- *회차 연속 제출 콤보*: 꾸준히 작성하면 *추가 포인트* 획득(꽤 많아요)\n"
                        "- *코어 채널 순위*: 코어 채널 제출 순위 따라 1, 2, 3등 *추가 포인트* 획득",
                    }
                ),
                DividerBlock(),
                # 참여 관련 포인트
                SectionBlock(
                    text={
                        "type": "mrkdwn",
                        "text": "*🏡 참여 관련 포인트*\n"
                        "- *커피챗 인증*: 커피챗을 인증하면 *N 포인트* 획득\n"
                        "- *빌리지 반상회 참여*: 반상회 참여 시 *N 포인트* 획득(수동 지급)",
                    }
                ),
                DividerBlock(),
                # 큐레이션 관련 포인트
                SectionBlock(
                    text={
                        "type": "mrkdwn",
                        "text": "*✍️ 큐레이션 관련 포인트*\n"
                        "- *큐레이션 요청*: 글 제출 시 큐레이션을 요청하면 *N 포인트* 획득\n"
                        "- *큐레이션 선정*: 큐레이션에 선정되면 추가 *N 포인트* 획득(수동 지급)",
                    }
                ),
                DividerBlock(),
                # 공지사항 관련 포인트
                SectionBlock(
                    text={
                        "type": "mrkdwn",
                        "text": "*📢 공지사항 관련 포인트*\n"
                        "- *공지사항 이모지*: 공지사항에 `공지확인` 이모지를 남기면 *N 포인트* 획득",
                    }
                ),
                DividerBlock(),
                # 자기소개 작성 포인트
                SectionBlock(
                    text={
                        "type": "mrkdwn",
                        "text": "*👋 자기소개 작성 포인트*\n"
                        "- *자기소개 작성하기*: 자기소개 작성 시 *N 포인트* 획득(수동 지급)",
                    }
                ),
                DividerBlock(),
                # 기타 지급 포인트
